...
public class TB {
    ...
    public TB(int TB_ID, int TB_TeacherID, int TB_BuildingID, String teacher_Name, String teacher_Sex, String teacher_Tel, String teacher_Username, String building_Name) {
        this.TB_ID = TB_ID;
